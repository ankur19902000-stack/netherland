# 🇳🇱 NLJOBS.nl — 100,000 Jobs Portal | Netherlands

## Domain
**https://rightwingnietherland.up.railway.app**

## Features
- ✅ 100,000 unique job pages (`/jobs/1` → `/jobs/100000`)
- ✅ JSON-LD JobPosting schema on every job page
- ✅ 50% Remote jobs, 50% On-site jobs across all 12 provinces
...
## Sitemap Structure
- **Sitemap Index:** `https://rightwingnietherland.up.railway.app/sitemap.xml`
